...
def obtener_bloques():                              # Función para validar que el usuario ingrese un número entero positivo
...
def calcular_piramide(bloques):                    # Función para calcular la altura de la pirámide y los bloques sobrantes
...
def dibujar_piramide(altura):                     # Función para dibujar la pirámide
